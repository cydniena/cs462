...
// import { Table } from 'react-chartjs-2';
...
//             // Check if the room was unbooked and utilized at any point during the day
//             const wasUnbookedUtilized = roomDataForDay.some(roomData => {
//               const bookedStatus = isRoomBooked(roomName, roomData.Time);
//               return bookedStatus === 'unbooked' && roomData.Count > 0;
//             });
            
//             if (wasUnbookedUtilized) {
//               unbookedUtilizedRooms++;
//             }
//           }
//         });
...
//             // Check if the room was unbooked and utilized at any point during the week
//             const wasUnbookedUtilized = roomDataForWeek.some(roomData => {
//               const bookedStatus = isRoomBooked(roomName, roomData.Time);
//               return bookedStatus === 'unbooked' && roomData.Count > 0;
//             });
...
//       if (totalRooms > 0) {
//         const percentage = (unbookedUtilizedRooms / totalRooms) * 100;
//         results.push({
...
//       <p>Percentage of rooms not booked but utilized (Count {'>'} 0)</p>
...
//         <div style={{ marginTop: '30px', height: '400px', marginBottom: '50px' }}>
//           <h3>Visualization</h3>
//           <Bar
//             data={{
...
//                 title: {
//                   display: true,
//                   text: 'Percentage of Rooms Not Booked but Utilized'
//                 },
//                 tooltip: {
//                   callbacks: {
...
//                         `Unbooked & Utilized: ${data.unbookedUtilizedRooms}`,
...
//                 <th style={{ padding: '12px', textAlign: 'right', borderBottom: '1px solid #ddd' }}>Unbooked & Utilized Rooms</th>
...
//                   <td style={{ padding: '12px', textAlign: 'right' }}>{data.unbookedUtilizedRooms}</td>
